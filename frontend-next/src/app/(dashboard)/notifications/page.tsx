...
export default function NotificationsPage() {
  ...
  const getIcon = (type: string) => {
    switch (type) {
      case 'crisis_alert': return <ExclamationCircleIcon className="h-6 w-6 text-red-500" />;
      case 'booking_confirmed': return <CheckCircleIcon className="h-6 w-6 text-green-500" />;
      case 'system_announcement': return <InformationCircleIcon className="h-6 w-6 text-blue-500" />;
      default: return <BellIcon className="h-6 w-6 text-purple-500" />;
    }
  };
